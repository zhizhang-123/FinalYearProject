...
const Map<String, Map<String, String>> diseaseSolutions = {
  'anthracnose': {
    'symptoms': '1. Dark brown or black circular or irregular spots\n2. Spots may have darker margins and lighter centers\n3. Severe infection causes leaf drying and leaf drop',
    'causes': '1. Environmental Conditions:\nHigh humidity and frequent rainfall\nOptimal temperature: 20–30°C\nPoor air circulation and poor drainage\n\n2. Other Causes:\nFungal spores spread through: Rain splash, Wind, Contaminated Tools and Hands\nThe fungus survives in: Soil, Infected Plant Debris, Diseased Leaves',
    'solution': '1. Remove and destroy infected leaves\n2. Avoid overhead water\n3. Improve air circulation and plant spacing',
    'pesticide': 'Naminche->0.75 ml of Namiche per 1L water (Every 7-10days)',
    'keyword': 'Namiche racun',
  },
  'powdery_mildew': {
    ...
    'pesticide': 'Sulfur sprays->2-3g sulfur per 1L water(Every 5-7days)',
    'keyword': 'Sulfur sprays for plant',
  },
  'wither': {
  ...
  'rust':{
    ...
    'pesticide': 'Copper-based fungicides->1-2g copper per 1L water (Every 7-14days)',
    'keyword': 'Copper-based fungicide',
  },
  'insect_damage':{
    'symptoms':'Holes or chewed edges on leaves',
    'causes':'1. Insect Pests:\n- Worm\n\n2. Enviromental Factors:\n- Warm and dry weather\n- Poor plant hygiene\n\n3. Plant Stress:\n- Weak plant\n- Excess nitrogen fertilizers',
    'solution':'1. Manually remove insects using hands or water stray\n2. Remove and destroy heavily infected leaves\n3. Improve air circulation and plant spacing\n4. Keep plants healthy with proper watering and fertilization\n5. Regularly inspect leaves (especially underside)',
    'pesticide':'Neem Oil->2-3ml neem oil per 1L water (Every 5-7days)',
    'keyword': 'Neem Oil',
  },
};
...
class SolutionPage extends StatelessWidget {
  ...
  Future<void> _searchPesticideOnShopee(BuildContext context) async {
    try {
      ...
      final String searchQuery = info != null && info.containsKey('keyword')? info['keyword']! : "$diseaseName pesticide";
